...
let reuseView = vscode.workspace.getConfiguration("angular2-switcher").get("reuseView");
...
let specFormats = vscode.workspace.getConfiguration("angular2-switcher").get("specFormats");
    ...
    return __awaiter(this, void 0, void 0, function* () {
        ...
        for (let index = 0; index < formats.length; index++) {
            ...
            if (reuseView && !!textEditor) {
                yield vscode.window.showTextDocument(textEditor.document, textEditor.viewColumn);
                break;
            }
...
function fileIsSpec(path) {
    return common_1.fileIs(path, ...specFormats);
}
