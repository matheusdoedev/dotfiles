...
exports.appendSelectedTextToFile = exports.replaceSelectionWith = exports.switchToDestinationFileIfRequired = void 0;
...
exports.appendSelectedTextToFile = ({ text: selection }, destinationPath) => {
    let text;
    text = selection;
    return file_system_1.appendTextToFile(`${text}`, destinationPath);
};
