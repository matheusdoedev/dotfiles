...
function toInteractiveDocumentElement(cell) {
    ...
    return {
        ...
        kernelName: (0, interactiveNotebook_1.getSimpleLanguage)(cell.languageId),
        contents: cell.value,
...
function toVsCodeNotebookCellData(cell) {
    const cellData = new vscode.NotebookCellData((0, interactiveNotebook_1.languageToCellKind)(cell.kernelName), cell.contents, (0, interactiveNotebook_1.getNotebookSpecificLanguage)(cell.kernelName));
